...
async function main() {
  ...
  try {
    ...
    console.log(JSON.stringify({ sharedSettings: 'passed', consistentLayout: 'passed', fullReview: 'passed', automaticAnnotation: 'controls-passed', documentSwitchPersistence: 'passed', countdown: 'passed', markdown: 'passed', disclaimer: 'persisted', automaticContext: 'conservative-free-note-pass', contexts: 2, contextPersistence: 'passed', annotationSuggestion: 'passed', copyAndWriteback: 'passed', replyVisibility: 'passed', replyPersistence: 'passed' }))
  } finally {
