...
try {
  ...
  Invoke-Native -Command 'node' -Arguments @('scripts/document-archives-ui-smoke.cjs')
  ...
  Invoke-Native -Command 'npm' -Arguments @('run', 'test:bookmarks-ui')
  Invoke-Native -Command 'npm' -Arguments @('run', 'test:pdf-links-ui')
  ...
  Invoke-Native -Command 'npm' -Arguments @('run', 'test:selection-test3')
  Invoke-Native -Command 'npm' -Arguments @('run', 'test:selection-m91474')
  Invoke-Native -Command 'npm' -Arguments @('run', 'test:selection-scheduling-inline')
  ...
  Invoke-Native -Command 'node' -Arguments @('scripts/window-tabs-smoke.cjs')
  Invoke-Native -Command 'node' -Arguments @('scripts/bookmark-ui-smoke.cjs')
  Invoke-Native -Command 'node' -Arguments @('scripts/pdf-links-ui-smoke.cjs')
  ...
  [ordered]@{
    ...
    tests = @('document-archives-ui', 'packaged-document-archives-ui', 'ai-settings-ui', 'packaged-ai-settings-ui', 'ocr-ui', 'packaged-ocr-ui', 'typography', 'typography-ui', 'packaged-typography-ui', 'annotation-dialog-ui', 'packaged-annotation-dialog-ui', 'ai-smoke', 'annotation-editor-ui', 'packaged-ai-smoke', 'packaged-annotation-editor-ui', 'popups-ui', 'eps-vector', 'packaged-popups-ui', 'packaged-eps-vector', 'typecheck', 'unit', 'i18n-catalogue', 'i18n-ui', 'workflow-state-ui', 'lab-features-ui', 'creative-tools-ui', 'print-native-cjs', 'print-ui', 'window-tabs', 'bookmarks-ui', 'pdf-links-ui', 'bookmark-recognition-papers', 'page-text-edit-ui', 'page-manager-input-ui', 'selection-scheduling', 'selection-scheduling-ui', 'selection-scheduling-0826', 'selection-scheduling-0826-ui', 'selection-test2', 'selection-test2-ui', 'selection-test3', 'selection-test3-ui', 'selection-m91474', 'selection-scheduling-inline', 'citations-scheduling-0826', 'reading-navigation-ui', 'selection-chinese', 'selection-chinese-ui', 'selection-bc', 'selection-bc-ui', 'heavy-image-page-ui', 'packaged-native-backend', 'packaged-release-ui', 'packaged-workflow-state-ui', 'packaged-lab-features-ui', 'packaged-creative-tools-ui', 'packaged-print-ui', 'packaged-window-tabs', 'packaged-bookmarks-ui', 'packaged-pdf-links-ui', 'packaged-bookmark-recognition-papers', 'packaged-page-manager-input-ui', 'packaged-selection-scheduling-0826-ui', 'packaged-selection-test2-ui', 'packaged-selection-test3-ui', 'packaged-reading-navigation-ui', 'packaged-selection-chinese-ui', 'packaged-selection-bc-ui', 'packaged-heavy-image-page-ui')
