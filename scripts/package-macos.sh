...
node scripts/document-archives-ui-smoke.cjs
...
PDFUCK_SMOKE_EXECUTABLE="$release_executable" PDFUCK_RELEASE_VERSION="$version" node scripts/document-archives-ui-smoke.cjs
