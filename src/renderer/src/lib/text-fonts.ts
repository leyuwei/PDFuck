...
export const FONT_OPTIONS: FontOption[] = [
  ...
  { value: 'Microsoft YaHei', label: "ui.microsoftYahei", category: 'sans' },
  { value: 'SimHei', label: "ui.simhei", category: 'sans' },
  { value: 'Times New Roman', label: 'Times New Roman', category: 'serif' },
  { value: 'Georgia', label: 'Georgia', category: 'serif' },
  { value: 'Cambria', label: 'Cambria', category: 'serif' },
  { value: 'SimSun', label: "ui.simsun", category: 'serif' },
  { value: 'KaiTi', label: "ui.kaiti", category: 'serif' },
  { value: 'FangSong', label: "ui.fangsong", category: 'serif' },
