...
export function BookmarkRecognitionDialog({ existingCount, onPreview, onCancel, onApply, onDeleteAll }: Props) {
  ...
  return <div className="modal-backdrop bookmark-recognition-backdrop"><ScrollWindow className="modal bookmark-recognition-dialog" role="dialog" aria-modal="true" aria-labelledby="bookmark-recognition-title">
